...
const addComment = async (req, res) => {
  ...
  try {
    ...
    // 4.1.7: Truy vấn Book trong database để tìm sách/truyện có id chương truyện
    ...
    // 4.1.8: Lấy ra chương truyện/sách có id tương ứng
    ...
    // 8.1.2: Trả về mã lỗi 500 với thông điệp lỗi server
